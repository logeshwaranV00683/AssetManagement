...
public class PasswordResetController {
    ...
    public ResponseEntity<?> verifyOtpAndResetPassword(@RequestBody @Validated({Default.class, ValidationGroups.OnForgotViaOtp.class}) ResetPasswordDTO resetPassword) {
    ...
    public ResponseEntity<?> changePasswordWithCurrent(@RequestBody @Validated({Default.class,ValidationGroups.OnChangeWithOldPassword.class}) ResetPasswordDTO changePassword) {
